...
public class JwtUtilWithRedis {
    ...
    public JwtUtilWithRedis(RedisTemplate<String, String> redisTemplate) {
    ...
    // JWT 토큰을 Redis에 저장
    public void saveTokenInRedis(String token, long expirationTimeInSeconds) {
        redisTemplate.opsForValue().set(token, "active", expirationTimeInSeconds, TimeUnit.SECONDS);
    }
